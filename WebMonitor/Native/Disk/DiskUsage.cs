...
public class DiskUsage : IRefreshable
{
    ...
    [SupportedOSPlatform("windows10.0")] private Win.DiskStats _oldDiskStatsWin = default!;
    ...
    public DiskUsage(DiskInfo diskInfo)
    {
        ...
        {
            _oldDiskStatsWin = new Win.DiskStats(diskInfo.DriveIndex);
        }
    ...
    public void Refresh(int millisSinceRefresh)
    {
        if (OperatingSystem.IsWindowsVersionAtLeast(10))
        {
            var newDiskStats = new Win.DiskStats(_diskInfo.DriveIndex);
